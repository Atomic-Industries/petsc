...
.   array - pointer to the data
   ...
   Fortran Note:
   Use `MatSeqAIJGetArrayF90()`, this routine is deprecated in Fortran (since version 3.19)
...
-  array - pointer to the data
   ...
   Fortran Note:
   Use `MatSeqAIJRestoreArrayF90()`, this routine is deprecated in Fortran (since version 3.19)
