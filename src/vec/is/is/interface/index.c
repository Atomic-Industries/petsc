...
.  ptr - the location to put the pointer to the indices
   ...
   Fortran Note:
   Use `ISGetIndicesF90()`, this routine is deprecated in Fortran (since version 3.19)
...
-  ptr - the pointer obtained by ISGetIndices()
   ...
   Fortran Note:
   Use `ISRestoreIndicesF90()`, this routine is deprecated in Fortran (since version 3.19)
