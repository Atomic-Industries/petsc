...
.  a - location to put pointer to the array
   ...
   Fortran Note:
   Use `VecGetArrayF90()`, this routine is deprecated in Fortran (since version 3.19)
...
-  a - location of pointer to array obtained from `VecGetArray()`
   ...
   Fortran Note:
   Use `VecRestoreArrayF90()`, this routine is deprecated in Fortran (since version 3.19)
...
.  a - the array
   ...
   Fortran Note:
   Use `VecGetArrayReadF90()`, this routine is deprecated in Fortran (since version 3.19)
...
-  array - the array
   ...
   Fortran Note:
   Use `VecRestoreArrayReadF90()`, this routine is deprecated in Fortran (since version 3.19)
...
.  a - location to put pointer to the array
   ...
   Fortran Note:
   Use `VecGetArrayWriteF90()`, this routine is deprecated in Fortran (since version 3.19)
...
-  a - location of pointer to array obtained from `VecGetArray()`
   ...
   Fortran Note:
   Use `VecRestoreArrayWriteF90()`, this routine is deprecated in Fortran (since version 3.19)
